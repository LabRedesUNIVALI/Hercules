    ...
    return action$
        ...
        .switchMap(id =>
            Api.get(`/tests/${id}`, { auth: true })
                ...
                .catch(error =>
                    Observable.of(actions.fetchTestFailure(error.xhr.response))
                )
        );
}
    ...
    return action$
        ...
        .switchMap(params =>
            Api.get(`/tests?${querystring.stringify(params)}`, { auth: true })
                ...
                .catch(error =>
                    Observable.of(actions.fetchTestsFailure(error.xhr.response))
                )
        );
}
    ...
    return action$
        ...
        .switchMap(test =>
            Api.post('/tests', test, { auth: true })
                ...
                .catch(error =>
                    Observable.of(actions.createTestFailure(error.xhr.response))
                )
        );
}
    ...
    return action$
        ...
        .switchMap(test =>
            Api.put(`/tests/${test.id}`, test, { auth: true })
                ...
                .catch(error =>
                    Observable.of(actions.updateTestFailure(error.xhr.response))
                )
        );
}
    ...
    return action$
        ...
        .switchMap(test =>
            Api.delete(`/tests/${test.id}`, { auth: true })
                ...
                .catch(error =>
                    Observable.of(actions.deleteTestFailure(error.xhr.response))
                )
        );
}
